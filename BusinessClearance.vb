...
Public Class BusinessClearance
    ...
    Async Function InsertQuery() As Task(Of Integer)
        ...
        Using mycmd As New OleDbCommand("INSERT INTO tbl_business(FULLNAME,BUSINESSNAME, BUSINESSLOCATION, DATEISSUED, ORNO, CTCNO, VALIDITY, AMOUNT) 
                                         VALUES(@FULLNAME, @BUSINESSNAME, @BUSINESSLOCATION, @DATEISSUED, @CTCNO, @ORNO, @VALIDITY, @AMOUNT)", con)
    ...
    Private Async Sub BtnSave_Click(sender As Object, e As EventArgs) Handles BtnSave.Click
        If String.IsNullOrEmpty(TxtName.Text) Or String.IsNullOrEmpty(TxtBusinessname.Text) Or String.IsNullOrEmpty(TxtBusinesslocation.Text) Or String.IsNullOrEmpty(TxtOr.Text) Or String.IsNullOrEmpty(TxtCtc.Text) Then
        ...
        Try
            If BtnSave.Text = "SAVE" Then
                ...
                UpdateWordDocs("C:\Capstone\BSITCapstone\Docs\TempBusinessC.docx")
                ResetTextFields()
            Else
                Await UpdateQuery()
